...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Agregar Película') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('movies.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="synopsis" class="form-control @error('synopsis') is-invalid @enderror" name="synopsis" required autocomplete="synopsis">{{ old('synopsis') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    @foreach ($genres as $genre)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="genres[]" id="genre_{{ $genre->id }}" value="{{ $genre->id }}" {{ in_array($genre->id, old('genres', [])) ? 'checked' : '' }}>
